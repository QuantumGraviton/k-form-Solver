...
filenames[0] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_0.8000000000_gamma_2.0000000000.txt"
filenames[1] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_1.0000000000_gamma_2.0000000000.txt"
filenames[2] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_1.4000000000_gamma_2.0000000000.txt"
filenames[3] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_2.0000000000_gamma_2.0000000000.txt"
#
filenames[4] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_0.8000000000_gamma_3.0000000000.txt"
filenames[5] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_1.0000000000_gamma_3.0000000000.txt"
filenames[6] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_1.4000000000_gamma_3.0000000000.txt"
filenames[7] = "../output/ECstar_curve_const_mass_with_different_beta_EOS_DD2_nsmass_2.0000000000_gamma_3.0000000000.txt"
...
axs[0].plot(df[0][:,indices_star['beta']], df[0][:,indices_star['R_NS']], lw=linew, ls = "-", color ="green", label="$0.8 M_\odot$")
axs[0].plot(df[1][:,indices_star['beta']], df[1][:,indices_star['R_NS']], lw=linew, ls = "-", color ="blue", label="$1.0 M_\odot$")
axs[0].plot(df[2][:,indices_star['beta']], df[2][:,indices_star['R_NS']], lw=linew, ls = "-", color ="black", label="$1.4 M_\odot$")
axs[0].plot(df[3][:,indices_star['beta']], df[3][:,indices_star['R_NS']], lw=linew, ls = "-", color ="red", label="$2.0 M_\odot$")

axs[1].plot(df[4][:,indices_star['beta']], df[4][:,indices_star['R_NS']], lw=linew, ls = "-", color ="green", label="$0.8 M_\odot$")
axs[1].plot(df[5][:,indices_star['beta']], df[5][:,indices_star['R_NS']], lw=linew, ls = "-", color ="blue", label="$1.0 M_\odot$")
axs[1].plot(df[6][:,indices_star['beta']], df[6][:,indices_star['R_NS']], lw=linew, ls = "-", color ="black", label="$1.4 M_\odot$")
axs[1].plot(df[7][:,indices_star['beta']], df[7][:,indices_star['R_NS']], lw=linew, ls = "-", color ="red", label="$2.0 M_\odot$")
...
# ----- add legends:
legend_ax0 = axs[0].legend(loc="upper right", fontsize = 9)
...
axs[1].set_ylabel("$R_{NS}$ [km]", fontsize = 18)
...
# plot labeling etc.:
# text in the plot:
axs[0].text(35., 13.25, "Preliminary", fontsize = 24, rotation='horizontal', c="gray", alpha=0.5)
