...
filenames[4] = "../output/ECstar_curve_EOS_APR_beta_0.0000000000_gamma_2.0000000000.txt"
filenames[5] = "../output/ECstar_curve_EOS_APR_beta_10.0000000000_gamma_2.0000000000.txt"
filenames[6] = "../output/ECstar_curve_EOS_APR_beta_20.0000000000_gamma_2.0000000000.txt"
filenames[7] = "../output/ECstar_curve_EOS_APR_beta_100.0000000000_gamma_2.0000000000.txt"


#label_names = ["APR","DD2","FSG","KDE0v1","LNS"]
label_names = ["Pure DD2","$\\beta = 10$","$\\beta = 20$","$\\beta = 100$","Pure APR","$\\beta = 10$","$\\beta = 20$","$\\beta = 100$"]
...
linecolors = [c1,c1,c1,c1,c2,c2,c2,c2]#"#DF5327","#DF5327"]
linestyles = ["-",":","-.","--","-",":","-.","--"]
for i in range(len(filenames)):
...
plt.legend(loc="lower left", fontsize = 11, ncol=1)
...
plt.text(9.1, 2.4, r"PSR J0952−0607", fontsize=8,color="sandybrown")
